...
fight k m
    ...
    | otherwise = fight k{ knightHealth = knightHealth k - monsterAttack m} m{ monsterHealth = monsterHealth m - knightAttack k}
{- |
=🛡= Sum types
...
-}
data MealType = Breakfast | Brunch | Lunch | Dinner | Midnightsnack | Dessert
{- |
=⚔️= Task 4
...
data Castle = None | JustCastle String | CastleWithWalls String
data Building = Church | Library
{- Why cant I create a House like this ?
data House = 1 | 2 | 3 | 4
-}
...
buildCastle castleName city = case cityCastle city of
  ...
  _ -> city {cityCastle = JustCastle castleName}
